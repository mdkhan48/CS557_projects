...
#blockSize - It is the size of neighbourhood considered for corner detection = 2
#ksize - Aperture parameter of Sobel derivative used. = 3
#k - Harris detector free parameter in the equation. = alpha
...
# Threshold for an optimal value, it may vary depending on the image.
#img[dst>(1-threshold)*dst.max()]=[255,0,0
