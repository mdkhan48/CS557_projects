...
# Use sobel filters to get horizontal and vertical gradients
#Ix = convolve(gray, [[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]])
#Iy = convolve(gray, [[1, 2, 1], [0, 0, 0], [-1, -2, -1]])
...
#hough_space = cv2.normalize(hough_space, hough_space, 0, 255, cv2.NORM_MINMAX) # normalize value between 0-255
...
#cv2.imshow("Implemented: Detected Lines (in red)", img1)
...
#cv2.imshow("OpenCV: Detected Lines (in red)", img2)
#cv2.waitKey(0)
